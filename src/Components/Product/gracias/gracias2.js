...
function Gracias2(props) {
    return (
        <Box>
            ...
            <Center>
                <Image src="https://i.imgur.com/k4PcEsi.png" height="100px" />
            </Center>
            <Button><a href='/' download="https://i.imgur.com/k4PcEsi.png" className="Text">Descargar</a></Button>
